...
from multimer import feature_processing, mmcif_parsing, parsers
...
def process(input_file, config_multimer):
    ...
    for chain in inputs.keys():
        ...
        if ('hhr' in inputs[chain].keys()):
            ...
            hhr = None
        chain_features = process_single_chain(chain, inputs[chain]['sequence'], inputs[chain]['description'],
                                              inputs[chain]['a3m'], is_homomer_or_monomer, hhr)
