...
import os
from multimer import msa_pairing, modules_multimer, config_multimer, load_param_multimer, pdb_to_template, test_multimer
...
if __name__ == '__main__':
    with open('./test/7epe/7epe.json') as f:
        json_data = json.load(f)
    mul_dataset = MultimerDataset(json_data, './test/7epe')
