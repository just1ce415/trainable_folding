...
class MultimerDataset(Dataset):
    ...
    def process(self, idx):
        ...
        all_chain_features={}
        for chain in chains:
            a3m_file = os.path.join(self.pre_align, f'{file_id}_{chain}', 'a3m/uniref90_hits.a3m')
            hhr_file = os.path.join(self.pre_align, f'{file_id}_{chain}', 'hhr/pdb70_hits.hhr')
        ...
        np_example = crop_feature(np_example, 300)
...
if __name__ == '__main__':
    ...
    mul_dataset = MultimerDataset(json_data, '/gpfs/alpine/bip215/proj-shared/openfold_train_data/')
